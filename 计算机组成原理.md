...
**$[0.11111]_2=1×2^{-1}+1×2^{-2}+1×2^{-3}+1×2^{-4}=[+0.9375]_{10}$，但是此处无需转化为十进制数，为方便计算我们应将其转化为对应的r=8进制数，**
...
**然而，IEEE 754单精度浮点数格式中的尾数虽然为定点小数，但其格式与我们之前复习的定点小数格式稍有不同，小数点隐含固定在尾数前面，而将原本小数点相邻左侧的符号位前移到最左侧，也就是IEEE 754单精度浮点数格式中的最高位作为符号位，如上图所示，而在小数点的相邻左侧隐藏一个1，但用来表示数值而不表示符号。为方便后续描述，我们用大写字母S表示符号位，大写字母E表示阶码，大写字母M表示尾数，这样，万完整的尾数形式应该表示为`1.M`**
...
![image-20250512205909670](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250512205909670.png#400h)
...
![image-20250514201849267](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250514201849267.png#400h)
...
**其中，`b0_mask|b5_mask`是将b0和b5的掩码先合并，然后再进行与运算，实现将b0和b5同时清0，下一句中`b2_mask|b3_mask`也是先将b2和b3的掩码县合并，然后再一起置1**
...
\begin{cases}
	...
	\end{cases}
$$
**上述溢出检测的逻辑表达式，第一个表达式可以认为$x_{n-1}与y_{n-1}$同为1，$\overline{s}_{n-1}$为0时，结果为1；第二个表达式可以认为$x_{n-1}与y_{n-1}$同为0，$\overline{s}_{n-1}$为1时，结果为1，将这两个表达式进行逻辑或运算，即可得到溢出标志位OF的逻辑表达式，如下图所示**
...
![image-20250516170141580](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250516170141580.png#400h)
...
![image-20250516181258269](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250516181258269.png#400h)
...
![image-20250516205640092](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250516205640092.png#400h)
...
![image-20250519191126284](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250519191126284.png#400h)
...
![image-20250519204834812](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250519204834812.png#400h)

![image-20250519205036555](C:/Users/triste/AppData/Roaming/Typora/typora-user-images/image-20250519205036555.png#400h)
